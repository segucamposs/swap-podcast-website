  ...
  return (
    <div className="rounded-2xl overflow-hidden max-w-[480px] mx-auto" style={{ backgroundColor: "#1a1a1a" }}>
      ...
      <div className="flex items-stretch">
        ...
        {/* Info */}
        <div className="flex-1 px-5 pt-5 pb-3 relative min-w-0 overflow-hidden">
          {/* Spotify logo — circle outlined, top right */}
          <a
            href={spotifyUrl}
            target="_blank"
            ...
            className="absolute top-4 right-4 w-9 h-9 rounded-full border-2 border-white/60 flex items-center justify-center text-white hover:border-white hover:text-white transition-colors duration-150"
          >
          ...
          {/* Title — single line, overflow hidden (no ellipsis, Spotify style) */}
          <p className="text-white font-bold text-[15px] leading-snug pr-12 whitespace-nowrap overflow-hidden mb-1">
